...
function Footer() {
  return (
    <footer id="about" className="bg-slate-900 text-slate-300 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-5 gap-12">
          {/* Brand */}

          <div className="lg:col-span-2">
            <h2 className="text-4xl font-extrabold text-white">VendorVerse</h2>

            <p className="mt-6 leading-8 text-slate-400 max-w-md">
              Connecting customers with trusted local vendors across
              Chhattisgarh for weddings, birthdays, corporate events and every
              special occasion.
            </p>
        ...
        <div className="border-t border-slate-700 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-5">
            ...
            <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center">
              <FaLinkedinIn className="hover:text-emerald-400 cursor-pointer transition" />
            </div>
